...
const Sidebar = ({showSidebar, setShowSidebar}) => {
     ...
     const [allNav, settAllNav ] = useState([])
    ...
    return (
        <div>
            <div onClick={()=> setShowSidebar(false)} className={`flex duration-200 ${!showSidebar ? 'invisible' : 'visible'} w-screen h-screen bg-[#22292f80] top-0 left-0 z-10`}></div>
            ...
            <div className='h-[70px] flex justify-center intems-center'>
                ...
                <ul>
                    {
                        allNav.map((n,i) => <li key={i}>
                            ...
                            'text-[#030811] font-bold duration-200'} 
                             px-[12px] py-[9px] rounded-sm flex justify-start gap-[12px] 
